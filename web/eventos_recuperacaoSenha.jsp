...
<html lang="pt-br">
   <head>
      ...
      <title>Eventos - Recuperação de senha</title>
               ...
               <div class="row mt-4">
                  <div class="container" style="margin-bottom:330px;">
                     <div class="card mb-5 boxshadow">
                        ...
                        <div class="card-body">
                           <!-- texto da pagina -->
                           <form id="recuperarSenha" action="EmailSender" method="POST">
                              <label>Digite seu E-mail:</label>  
                              <input id="email" name="email" type="email" class="form-control input-md" required="">
                              <small id="emailHelp" class="form-text text-muted">Enviaremos um e-mail para cadastrar uma nova senha.</small>
                              <div class="checkbox">
                                 <input id="checkbox1" type="checkbox" required>
                                 Não sou uma máquina 									
                              </div>
                              <div class="form-group">
                                 <button id="confirmar" name="confirmar" type="submit" class="btn btn-primary">
                                 Confirmar
                                 </button>
                              </div>
                           </form>
