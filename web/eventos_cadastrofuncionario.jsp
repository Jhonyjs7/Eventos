                          ...
                          <div class="container ">
                              <div class="card mt-3 mb-5 boxshadow">
                                  <div class="card-header">
                                      ...
                                      <p class="text-center">Cadastro somente para funcionários da secretaria, não é permitido cadastro de terceitos.</p>
                                      <!-- titulo da pagina -->
                                  </div>
                                  <div class="card-body">
                                      <!-- texto da pagina -->
                                      <div class="">
                                          <form action="Cadastrar" method="post" accept-charset="iso-8859-1,utf-8">
                                              <label>Nome:</label>
                                              <input id="nnome" name="nome" type="text" maxlength="100" class="form-control input-md" required>
                                              ...
                                              <input id="csenha" name="csenha" type="password" class="form-control input-md" required>
                                              <div class="checkbox">
                                                  <input id="checkbox1" type="checkbox" required>
                                                  Eu li e concordo com os
                                                  <a  href="eventos_termosDeUso.jsp" > Termos de Uso</a>
                                              </div>
                                              <div class="form-group">
